        ...
        <div className="mt-6">
          <Link
            ...
            className={cn(
              ...
              "h-9 px-4 rounded-full border-border/80 hover:border-border hover:bg-paper text-xs font-medium text-foreground gap-1.5 transition-all active:scale-[0.98] outline-none focus-visible:ring-2 focus-visible:ring-ring"
            )}
          >
